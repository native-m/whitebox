...
inline void im_draw_rect_filled(
    ImDrawList* dl,
    float x0,
    float y0,
    float x1,
    ...
    float rounding = 0.0f,
    ImDrawFlags flags = 0) {
  dl->AddRectFilled(ImVec2(x0, y0), ImVec2(x1, y1), col, rounding, flags);
}

inline void im_draw_rect(
    ImDrawList* dl,
    float x0,
    float y0,
    float x1,
    ...
    float rounding = 0.0f,
    ImDrawFlags flags = 0) {
  dl->AddRect(ImVec2(x0, y0), ImVec2(x1, y1), col, rounding, flags);
}
