...
inline AudioFormat to_audio_format(pa_sample_format format) {
  switch (format) {
    case PA_SAMPLE_S16LE: return AudioFormat::I16;
    case PA_SAMPLE_S24LE: return AudioFormat::I24;
    case PA_SAMPLE_S24_32LE: return AudioFormat::I24_X8;
    case PA_SAMPLE_S32LE: return AudioFormat::I32;
    case PA_SAMPLE_FLOAT32LE: return AudioFormat::F32;
    default: break;
  }
...
inline pa_sample_spec to_sample_spec(AudioFormat format, AudioDeviceSampleRate sample_rate, uint16_t channels) {
  ...
  switch (format) {
    case AudioFormat::I16: ret.format = PA_SAMPLE_S16LE; break;
    case AudioFormat::I24: ret.format = PA_SAMPLE_S24LE; break;
    case AudioFormat::I24_X8: ret.format = PA_SAMPLE_S24_32LE; break;
    case AudioFormat::I32: ret.format = PA_SAMPLE_S32LE; break;
    case AudioFormat::F32: ret.format = PA_SAMPLE_FLOAT32LE; break;
    default: ret.format = PA_SAMPLE_INVALID; break;
  }
...
struct AudioIOPulseAudio2 : public AudioIO {
  ...
  bool exclusive_mode_support() override {
    return false;
  }
  bool shared_mode_support() override {
    return true;
  }
  ...
  bool open_device(AudioDeviceID output_device_id, AudioDeviceID input_device_id) override {
    ...
    switch (output_.default_sample_spec.rate) {
      case 44100: shared_mode_sample_rate = AudioDeviceSampleRate::Hz44100; break;
      case 48000: shared_mode_sample_rate = AudioDeviceSampleRate::Hz44100; break;
      case 88200: shared_mode_sample_rate = AudioDeviceSampleRate::Hz88200; break;
      case 96000: shared_mode_sample_rate = AudioDeviceSampleRate::Hz96000; break;
      case 176400: shared_mode_sample_rate = AudioDeviceSampleRate::Hz176400; break;
      case 192000: shared_mode_sample_rate = AudioDeviceSampleRate::Hz192000; break;
    }
  ...
  bool start(
    ...
    pa_stream_connect_playback(
        output_stream, output_.hw_name.c_str(), &output_buffer_attr, (pa_stream_flags)stream_flags, nullptr, nullptr);
      ...
      switch (instance->output_sample_format_) {
        case AudioFormat::I16:
          convert_f32_to_interleaved_i16(
              ...
              instance->output_buffer_.channel_buffers,
              offset,
