...
namespace wb
{
    ...
    {
        amount = 1.0f / (1.0f + amount);
        return ImColor(1.0f - (1.0f - color.Value.x) * amount,
    ...
    {
        return ImColor((color.Value.x - 0.5f) * amount + 0.5f,
    ...
    {
        return ImColor(color.Value.x * color.Value.w,
    ...
    {
        return ImColor(std::lerp(a.Value.x, b.Value.x, t),
                       std::lerp(a.Value.y, b.Value.y, t),
