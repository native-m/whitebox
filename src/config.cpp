  ...
  if (settings.contains("audio")) {
    ...
    if (audio.contains("sample_rate")) {
      ...
      switch (sample_rate_value) {
        case 44100: g_audio_sample_rate = AudioDeviceSampleRate::Hz44100; break;
        case 48000: g_audio_sample_rate = AudioDeviceSampleRate::Hz48000; break;
        case 88200: g_audio_sample_rate = AudioDeviceSampleRate::Hz88200; break;
        case 96000: g_audio_sample_rate = AudioDeviceSampleRate::Hz96000; break;
        case 176400: g_audio_sample_rate = AudioDeviceSampleRate::Hz176400; break;
        case 192000: g_audio_sample_rate = AudioDeviceSampleRate::Hz192000; break;
        default: g_audio_sample_rate = {}; break;
      }
    }
  }
